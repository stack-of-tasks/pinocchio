...
void exposeCentroidal(nb::module_ m)
{
  m.def(
    ...
    [](const Model & model, Data & data) -> Force {
  ...
  m.def(
    "computeCentroidalMomentum",
    [](const Model & model, Data & data, ConstVectorRef q, ConstVectorRef v) -> Force {
  ...
  m.def(
    ...
    [](const Model & model, Data & data, ConstVectorRef q, ConstVectorRef v, ConstVectorRef a)
      -> Force { return pinocchio::computeCentroidalMomentumTimeVariation(model, data, q, v, a); },
  ...
  m.def(
    "ccrba",
    [](const Model & model, Data & data, ConstVectorRef q, ConstVectorRef v) -> Data::Matrix6x {
      return pinocchio::ccrba(model, data, q, v);
    },
    "model"_a, "data"_a, "q"_a, "v"_a,
  ...
  m.def(
    ...
    [](const Model & model, Data & data, ConstVectorRef q) -> Data::Matrix6x {
  ...
  m.def(
    "dccrba",
    [](const Model & model, Data & data, ConstVectorRef q, ConstVectorRef v) -> Data::Matrix6x {
      return pinocchio::dccrba(model, data, q, v);
    },
    "model"_a, "data"_a, "q"_a, "v"_a,
