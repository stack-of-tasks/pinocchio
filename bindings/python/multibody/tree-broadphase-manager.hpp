...
#ifndef __pinocchio_python_algorithm_tree_broadphase_manager_hpp__
#define __pinocchio_python_algorithm_tree_broadphase_manager_hpp__
...
namespace pinocchio
{
  namespace python
  {
    ...
    public:
      ...
      {
        cl
        .def(bp::init<const Model *, const GeometryModel *, GeometryData *>(bp::args("self","model","geometry_model","geometry_data"),
      ...
      static void expose()
      {
        ...
        const std::string class_doc = "Tree-based broad phase manager associated to hpp::fcl::" + derived_name;
...
#endif // ifndef __pinocchio_python_algorithm_tree_broadphase_manager_hpp__
