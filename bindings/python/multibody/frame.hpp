  ...
  namespace python
  {
    ...
    : public boost::python::def_visitor< FramePythonVisitor<Frame> >
    {
      ...
      void visit(PyClass & cl) const
      {
        ...
        .def(bp::init< const std::string&,const JointIndex, const SE3&, FrameType, bp::optional<const Inertia&> > ((bp::arg("name"),bp::arg("parent_joint"), bp::arg("placement"), bp::arg("type"), bp::arg("inertia")),
