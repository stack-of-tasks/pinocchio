...
namespace pinocchio
{
    namespace python
    {
      ...
      static const context::MatrixXs computeDelassusMatrix_proxy(const context::Model & model,
                                                                 context::Data & data,
      ...
      static const context::MatrixXs computeDampedDelassusMatrixInverse_proxy(const context::Model & model,
                                                                              context::Data & data,
                                                                              const context::VectorXs & q,
                                                                              const RigidConstraintModelVector & contact_models,
                                                                              RigidConstraintDataVector & contact_datas,
                                                                              ...
                                                                              const bool scaled = false)
      {
        ...
        computeDampedDelassusMatrixInverse(model, data, q, contact_models, contact_datas, delassus_inverse, mu, scaled);
      ...
      void exposeDelassus()
      {
        ...
        bp::def("computeDelassusMatrix",computeDelassusMatrix_proxy,
                (bp::arg("model"),bp::arg("data"),bp::arg("q"),bp::arg("contact_models"),bp::arg("contact_datas"),bp::arg("mu") = 0),
                "Computes the Delassus matrix associated to a set of given constraints.");
        
        bp::def("computeDampedDelassusMatrixInverse",computeDampedDelassusMatrixInverse_proxy,
                (bp::arg("model"),bp::arg("data"),bp::arg("q"),bp::arg("contact_models"),bp::arg("contact_datas"),bp::arg("mu") = 0),
