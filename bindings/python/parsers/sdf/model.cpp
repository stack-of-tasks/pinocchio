...
namespace pinocchio
{
  namespace python
  {
                                ...
                                const std::vector<std::string>& parent_guidance)
    {
      ...
      ::pinocchio::sdf::buildModel(filename, model, contact_models, root_link_name, parent_guidance);
                                ...
                                const std::vector<std::string>& parent_guidance)
    {
      ...
      pinocchio::sdf::buildModel(filename, root_joint, model, contact_models,
                                 root_link_name, parent_guidance);
      return bp::make_tuple(model,contact_models);
    }
#endif
    ...
    void exposeSDFModel()
    {
      ...
      bp::def("buildModelFromSdf",
              static_cast <bp::tuple (*) (const std::string &, const std::string &, const std::vector<std::string>&)> (pinocchio::python::buildModelFromSdf),
      ...
      bp::def("buildModelFromSdf",
              static_cast <bp::tuple (*) (const std::string &, const JointModel &, const std::string &, const std::vector<std::string>&)> (pinocchio::python::buildModelFromSdf),
              (bp::arg("sdf_filename"),bp::arg("root_joint"),
