...
namespace pinocchio
{
  namespace python
  {
    ...
    GeometryModel buildGeomFromMJCF(Model& model,
    ...
    void exposeMJCFGeom()
    {
      bp::def("buildGeomFromMJCF",
              static_cast <GeometryModel (*) (Model &, const std::string &, const GeometryType&)> (pinocchio::python::buildGeomFromMJCF),
        ...
        bp::def("buildGeomFromMJCF",
              static_cast <GeometryModel (*) (Model &, const std::string &, const GeometryType&, ::hpp::fcl::MeshLoaderPtr&)> (pinocchio::python::buildGeomFromMJCF),
