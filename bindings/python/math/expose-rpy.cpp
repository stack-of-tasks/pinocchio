...
namespace pinocchio
{
  namespace python
  {
    ...
    context::Matrix3s rotate(const std::string & axis, const context::Scalar ang)
    {
      ...
      switch(axis_)
      {
        case 'x': u[0] = Scalar(1); break;
        case 'y': u[1] = Scalar(1); break;
        case 'z': u[2] = Scalar(1); break;
    ...
    void exposeRpy()
    {
...

      {
        ...
        bp::def("rpyToMatrix",
                static_cast<context::Matrix3s (*)(const context::Scalar&, const context::Scalar&, const context::Scalar&)>(&rpyToMatrix),
        ...
        bp::def("matrixToRpy",
//                &matrixToRpy<context::Matrix3s>, TODO: change internal routines to make them compliant with Autodiff Frameworks
                &matrixToRpy<Eigen::Matrix3d>,
                bp::arg("R"),
        ...
        bp::def("computeRpyJacobian",
                &computeRpyJacobian<context::Vector3s>,
        ...
        bp::def("computeRpyJacobianInverse",
                &computeRpyJacobianInverse<context::Vector3s>,
                (bp::arg("rpy"),bp::arg("reference_frame") = LOCAL),
