  ...
  namespace python
  {
    ...
    public:
      ...
      void visit(PyClass& cl) const 
      {
        ...
        .def(bp::init<const Scalar &,const Scalar &,const Scalar &,const Scalar &,const Scalar &,const Scalar &>
             ((bp::arg("self"),bp::arg("a0"),bp::arg("a1"),bp::arg("a2"),bp::arg("a3"),bp::arg("a4"),bp::arg("a5")),
              "Initialize from 6 scalar values."))
        .def(bp::init<const Symmetric3 &>((bp::arg("self"),bp::arg("other")),"Copy constructor."))
        .def("Zero",&Symmetric3::Zero,"Returns a zero 3x3 matrix.")
        .staticmethod("Zero")
        .def("setZero",&Symmetric3::setZero,bp::arg("self"),
              "Set all the components of *this to zero.")
        .def("Random",&Symmetric3::Random,"Returns a random symmetric 3x3 matrix.")
        .staticmethod("Random")
        .def("setRandom",&Symmetric3::setRandom,bp::arg("self"),
              "Set all the components of *this randomly.")        
        .def("Identity",&Symmetric3::Identity,"Returns identity matrix.")
        .staticmethod("Identity")
        .def("setIdentity",&Symmetric3::setIdentity,bp::arg("self"),
...
#endif
        .def("setDiagonal",&Symmetric3::template setDiagonal<Vector3Like>,
              bp::args("self","diag"),"Set the diagonal elements of 3x3 matrix.")
        .def("inverse",&Symmetric3::template inverse<Matrix3Like>,
              bp::args("self","res"),"Invert the symmetrical 3x3 matrix.")   
        ...
        .def(bp::self -= bp::other<AlphaSkewSquare>())      
        .add_property("data",
                      &Symmetric3PythonVisitor::getData,
                      &Symmetric3PythonVisitor::setData,
      ...
      private:
        ...
        struct Pickle : bp::pickle_suite
        {
          static
          boost::python::tuple
          getinitargs(const Symmetric3 & I)
