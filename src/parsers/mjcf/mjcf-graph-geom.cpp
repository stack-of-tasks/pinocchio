...
namespace pinocchio
{
    namespace mjcf
    {
        namespace details
        {
             ...
             */
#ifdef PINOCCHIO_WITH_HPP_FCL
            static std::shared_ptr<fcl::CollisionGeometry>
            ...
            void MjcfGeom::fill(const ptree &el, const MjcfBody &currentBody, const MjcfGraph &currentGraph)
            {
                // Name
            ...
            {
#ifdef PINOCCHIO_WITH_HPP_FCL
        if (!meshLoader) meshLoader = std::make_shared<fcl::MeshLoader>(fcl::MeshLoader());
