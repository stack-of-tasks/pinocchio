  ...
  namespace buildModels
  {
    namespace details
    {
                                           ...
                                           const std::string & pre = "")
      {
        ...
        GeometryObject shoulderBall(pre+"shoulder_object",
                                    ...
                                    SE3::Identity(),
                                    std::shared_ptr<fcl::Sphere>(new fcl::Sphere(0.05)),
                                    "SPHERE",
                                    Eigen::Vector3d::Ones(),
                                    false,
                                    meshColor);
        ...
        GeometryObject upperArm(pre+"upperarm_object",
                                ...
                                std::shared_ptr<fcl::Capsule>(new fcl::Capsule(0.05, .8)),
                                "CAPSULE",
                                Eigen::Vector3d::Ones(),
                                false,
                                meshColor);
        ...
        GeometryObject effectorArm(pre+"effector_object",
                                   ...
                                   std::shared_ptr<fcl::Capsule>(new fcl::Capsule(0.05, .2)),
                                   "CAPSULE",
                                   Eigen::Vector3d::Ones(),
                                   false,
                                   meshColor);
                            ...
                            GeometryModel & geom)
    {
      ...
      GeometryObject headBall("head_object",
                              ...
                              std::shared_ptr<fcl::Sphere>(new fcl::Sphere(0.25)),
                              "SPHERE",
                               Eigen::Vector3d::Ones(),
                               false,
                               meshColor);
