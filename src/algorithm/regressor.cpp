...
namespace pinocchio {
  ...
  template PINOCCHIO_EXPLICIT_INSTANTIATION_DEFINITION_DLLAPI context::Matrix6xs computeJointKinematicRegressor
  ...
  template PINOCCHIO_EXPLICIT_INSTANTIATION_DEFINITION_DLLAPI context::Matrix6xs computeFrameKinematicRegressor
    <context::Scalar, context::Options, JointCollectionDefaultTpl>
  (const context::Model &, context::Data &, const FrameIndex, const ReferenceFrame);

  template PINOCCHIO_EXPLICIT_INSTANTIATION_DEFINITION_DLLAPI context::Matrix3x & computeStaticRegressor
  ...
  template PINOCCHIO_EXPLICIT_INSTANTIATION_DEFINITION_DLLAPI void bodyRegressor
  ...
  template PINOCCHIO_EXPLICIT_INSTANTIATION_DEFINITION_DLLAPI context::BodyRegressorType bodyRegressor
    <context::Motion, context::Motion>
  (const MotionDense<context::Motion> &, const MotionDense<context::Motion> &);

  template PINOCCHIO_EXPLICIT_INSTANTIATION_DEFINITION_DLLAPI context::BodyRegressorType & jointBodyRegressor
    <context::Scalar, context::Options, JointCollectionDefaultTpl>
  (const context::Model &, context::Data &, JointIndex);

  template PINOCCHIO_EXPLICIT_INSTANTIATION_DEFINITION_DLLAPI context::BodyRegressorType & frameBodyRegressor
    <context::Scalar, context::Options, JointCollectionDefaultTpl>
