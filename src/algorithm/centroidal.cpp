...
namespace pinocchio {
  ...
  template PINOCCHIO_EXPLICIT_INSTANTIATION_DEFINITION_DLLAPI const ForceTpl<context::Scalar, context::Options> & computeCentroidalMomentum
...
namespace impl {
  ...
  template PINOCCHIO_EXPLICIT_INSTANTIATION_DEFINITION_DLLAPI const ForceTpl<context::Scalar, context::Options> & computeCentroidalMomentumTimeVariation
    <context::Scalar, context::Options, JointCollectionDefaultTpl>
  (const context::Model &, context::Data &);
namespace impl {
  template PINOCCHIO_EXPLICIT_INSTANTIATION_DEFINITION_DLLAPI const ForceTpl<context::Scalar, context::Options> & computeCentroidalMomentumTimeVariation
  ...
  template PINOCCHIO_EXPLICIT_INSTANTIATION_DEFINITION_DLLAPI const context::Matrix6xs & computeCentroidalMap
  ...
  template PINOCCHIO_EXPLICIT_INSTANTIATION_DEFINITION_DLLAPI const context::Matrix6xs & computeCentroidalMapTimeVariation
    <context::Scalar, context::Options, JointCollectionDefaultTpl, Eigen::Ref<const context::VectorXs>, Eigen::Ref<const context::VectorXs>>
  (const context::Model &, context::Data &, const Eigen::MatrixBase<Eigen::Ref<const context::VectorXs>> &, const Eigen::MatrixBase<Eigen::Ref<const context::VectorXs>> &);
} // namespace impl
} // namespace pinocchio
