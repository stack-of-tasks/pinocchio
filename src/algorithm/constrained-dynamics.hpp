...
#ifndef __pinocchio_constrained_dynamics_hpp__
#define __pinocchio_constrained_dynamics_hpp__
...
namespace pinocchio
{
  ...
  /// \param[in] J The Jacobian of the constraints (dim nb_constraints*model.nv).
  /// \param[in] gamma The drift of the constraints (dim nb_constraints).
  /// \param[in] mu Damping factor for cholesky decomposition of JMinvJt. Set to zero if constraints are full rank.
