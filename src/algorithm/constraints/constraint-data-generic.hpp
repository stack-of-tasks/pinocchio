...
, ConstraintCollectionTpl<_Scalar,_Options>::ConstraintDataVariant
{
  ...
  {
    BOOST_MPL_ASSERT((boost::mpl::contains<typename ConstraintDataVariant::types,ContraintDataDerived>));
  }
...
bool operator==(const ConstraintDataBase<ConstraintDataDerived> & data1,
