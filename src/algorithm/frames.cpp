...
namespace pinocchio {
  ...
  template PINOCCHIO_EXPLICIT_INSTANTIATION_DEFINITION_DLLAPI void updateFramePlacements
    <context::Scalar, context::Options, JointCollectionDefaultTpl>
  (const context::Model &, context::Data &);

  template PINOCCHIO_EXPLICIT_INSTANTIATION_DEFINITION_DLLAPI const SE3Tpl<context::Scalar, context::Options> & updateFramePlacement
    <context::Scalar, context::Options, JointCollectionDefaultTpl>
  ...
  template PINOCCHIO_EXPLICIT_INSTANTIATION_DEFINITION_DLLAPI MotionTpl<context::Scalar, context::Options> getFrameVelocity
    <context::Scalar, context::Options, JointCollectionDefaultTpl>
  ...
  template PINOCCHIO_EXPLICIT_INSTANTIATION_DEFINITION_DLLAPI MotionTpl<context::Scalar, context::Options> getFrameAcceleration
    <context::Scalar, context::Options, JointCollectionDefaultTpl>
  (const context::Model &, const context::Data &, const JointIndex, const SE3Tpl<context::Scalar, context::Options> &, const ReferenceFrame);
  ...
  template PINOCCHIO_EXPLICIT_INSTANTIATION_DEFINITION_DLLAPI context::Matrix6xs getFrameJacobian
    <context::Scalar, context::Options, JointCollectionDefaultTpl>
