...
namespace pinocchio { namespace impl {
  ...
  template PINOCCHIO_EXPLICIT_INSTANTIATION_DEFINITION_DLLAPI void computeForwardKinematicsDerivatives
  ...
  template PINOCCHIO_EXPLICIT_INSTANTIATION_DEFINITION_DLLAPI void getJointAccelerationDerivatives
  ...
  template PINOCCHIO_EXPLICIT_INSTANTIATION_DEFINITION_DLLAPI void getPointClassicAccelerationDerivatives
  ...
  template PINOCCHIO_EXPLICIT_INSTANTIATION_DEFINITION_DLLAPI void getJointKinematicHessian
    <context::Scalar, context::Options, JointCollectionDefaultTpl>
  (const context::Model &, const context::Data &, const JointIndex, const ReferenceFrame, Tensor<context::Scalar,3,context::Options> &);

  template PINOCCHIO_EXPLICIT_INSTANTIATION_DEFINITION_DLLAPI Tensor<context::Scalar,3,context::Options> getJointKinematicHessian
    <context::Scalar, context::Options, JointCollectionDefaultTpl>
  (const context::Model &, const context::Data &, const JointIndex, const ReferenceFrame);
} // namespace pinocchio
