...
namespace pinocchio {
  extern template PINOCCHIO_DLLAPI context::Matrix6xs & computeJointJacobians
  ...
  extern template PINOCCHIO_DLLAPI context::Matrix6xs & computeJointJacobiansTimeVariation
