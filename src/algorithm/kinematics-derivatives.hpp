...
namespace pinocchio
{
  ...
  ///
  /// \tparam JointCollection Collection of Joint types.
  /// \tparam Matrix3xOut1 Matrix6x containing the partial derivatives of the spatial velocity with respect to the joint configuration vector.
  /// \tparam Matrix3xOut2 Matrix6x containing the partial derivatives of the spatial velocity with respect to the joint velocity vector.
  /// \tparam Matrix3xOut3 Matrix6x containing the partial derivatives of the spatial acceleration with respect to the joint configuration vector.
  /// \tparam Matrix3xOut4 Matrix6x containing the partial derivatives of the spatial acceleration with respect to the joint velocity vector.
  /// \tparam Matrix3xOut5 Matrix6x containing the partial derivatives of the spatial acceleration with respect to the joint acceleration vector.
  ///
  /// \param[in] model The model structure of the rigid body system.
  /// \param[in] data The data structure of the rigid body system.
  ...
  /// \param[out] a_point_partial_dq Partial derivative of the point classic acceleration w.r.t. \f$ v \f$.
  /// \param[out] a_point_partial_dq Partial derivative of the point classic acceleration w.r.t. \f$ \dot{v} \f$.
  ///
