...
struct DataTpl : serialization::Serializable<
  ...
  /// \brief Combined variations of the inertia matrix \f$ B_i =  \frac{1}{2}
  /// [(v_i\times∗)I_i + (I_i v_i)\times^{∗} − I_i(v_i\times)] \f$  consistent
  ...
  /// \brief Temporary for SO derivative algorithms
  Motion S_dm;
  Motion psid_dm;
  Motion psidd_dm;
  Motion phid_dm;
  ...
  /// \brief SO Cross-Partial derivative of the joint torque vector with
  /// respect to the joint acceleration/configuration. This also reduces to the
