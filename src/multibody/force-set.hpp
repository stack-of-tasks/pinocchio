...
namespace pinocchio
{
  ...
  public:
    ...
    {  TEST_NEW_ASSERT( linear.cols() == angular.cols() ); }
	...
	return *this;
      ...
      {
        eigen_TEST_NEW_ASSERT(D::RowsAtCompileTime == 6);
        TEST_NEW_ASSERT(m.cols() == len);
