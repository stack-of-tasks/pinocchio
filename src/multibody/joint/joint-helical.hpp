...
namespace pinocchio
{
  ...
  : JointMotionSubspaceBase< JointMotionSubspaceHelicalTpl<_Scalar,_Options,axis> >
  {
    ...
    JointMotionSubspaceHelicalTpl(const Scalar & h) : m_pitch(h) {}
    ...
    se3Action(const SE3Tpl<S1,O1> & m) const
    {
      ...
      ReturnType res;
      res.template segment<3>(LINEAR) = m.translation().cross(m.rotation().col(axis)) + m_pitch * (m.rotation().col(axis));
  ...
  namespace impl
  {
    ...
    struct LhsMultiplicationOp<InertiaTpl<S1,O1>, JointMotionSubspaceHelicalTpl<S2,O2,0> >
    {
                                   ...
                                   const Constraint & constraint)
      {
        ...
        m*y,
        I(0,0)+m*(y*y+z*z),
        I(0,1)-m*x*y+m*z*m_pitch,
        I(0,2)-m*x*z-m*y*m_pitch;
    ...
    struct LhsMultiplicationOp<InertiaTpl<S1,O1>, JointMotionSubspaceHelicalTpl<S2,O2,1> >
    {
                                   ...
                                   const Constraint & constraint)
      {
        ...
        m*m_pitch,
        -m*x,
        I(1,0)-m*x*y-m*z*m_pitch,
        I(1,1)+m*(x*x+z*z),
        I(1,2)-m*y*z+m*x*m_pitch;
    ...
    struct LhsMultiplicationOp<InertiaTpl<S1,O1>, JointMotionSubspaceHelicalTpl<S2,O2,2> >
    {
                                   ...
                                   const Constraint & constraint)
      {
        ...
        m*x,
        m*m_pitch,
        I(2,0)-m*x*z+m*y*m_pitch,
        I(2,1)-m*y*z-m*x*m_pitch,
        I(2,2)+m*(x*x+y*y);
