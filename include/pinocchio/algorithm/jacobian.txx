...
namespace pinocchio { 
namespace impl {  
  extern template PINOCCHIO_EXPLICIT_INSTANTIATION_DECLARATION_DLLAPI const context::Matrix6xs & computeJointJacobians
...
namespace impl {  
  ...
  extern template PINOCCHIO_EXPLICIT_INSTANTIATION_DECLARATION_DLLAPI context::Matrix6xs getJointJacobian
  <context::Scalar, context::Options, JointCollectionDefaultTpl>
...
namespace impl {  
  ...
  extern template PINOCCHIO_EXPLICIT_INSTANTIATION_DECLARATION_DLLAPI const context::Matrix6xs & computeJointJacobiansTimeVariation
  ...
  extern template PINOCCHIO_EXPLICIT_INSTANTIATION_DECLARATION_DLLAPI void getJointJacobianTimeVariation
  <context::Scalar, context::Options, JointCollectionDefaultTpl, Eigen::Ref<context::Matrix6xs>>
  (const context::Model &, const context::Data &, const JointIndex, const ReferenceFrame, const Eigen::MatrixBase<Eigen::Ref<context::Matrix6xs>> &);
} // namespace impl   
} // namespace pinocchio
