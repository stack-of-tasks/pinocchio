...
namespace pinocchio {
  ...
  extern template PINOCCHIO_DLLAPI context::Matrix6xs computeJointKinematicRegressor
  ...
  extern template PINOCCHIO_DLLAPI context::Matrix6xs computeFrameKinematicRegressor
    <context::Scalar, context::Options, JointCollectionDefaultTpl>
  ...
  extern template PINOCCHIO_DLLAPI void bodyRegressor
  ...
  extern template PINOCCHIO_DLLAPI context::BodyRegressorType bodyRegressor
    <context::Motion, context::Motion>
    (const MotionDense<context::Motion> &, const MotionDense<context::Motion> &);

  extern template PINOCCHIO_DLLAPI context::BodyRegressorType & jointBodyRegressor
    <context::Scalar, context::Options, JointCollectionDefaultTpl>
    (const context::Model &, context::Data &, JointIndex);

  extern template PINOCCHIO_DLLAPI context::BodyRegressorType & frameBodyRegressor
    <context::Scalar, context::Options, JointCollectionDefaultTpl>
