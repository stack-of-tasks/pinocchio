...
namespace pinocchio {
  ...
  extern template PINOCCHIO_EXPLICIT_INSTANTIATION_DECLARATION_DLLAPI void computeJointKinematicRegressor
  ...
  extern template PINOCCHIO_EXPLICIT_INSTANTIATION_DECLARATION_DLLAPI context::Matrix6xs computeJointKinematicRegressor
  ...
  extern template PINOCCHIO_EXPLICIT_INSTANTIATION_DECLARATION_DLLAPI void computeFrameKinematicRegressor
    <context::Scalar, context::Options, JointCollectionDefaultTpl, context::Matrix6xs>
    (const context::Model &, context::Data &, const FrameIndex, const ReferenceFrame, const Eigen::MatrixBase<context::Matrix6xs> &);

  extern template PINOCCHIO_EXPLICIT_INSTANTIATION_DECLARATION_DLLAPI context::Matrix6xs computeFrameKinematicRegressor
    <context::Scalar, context::Options, JointCollectionDefaultTpl>
    (const context::Model &, context::Data &, const FrameIndex, const ReferenceFrame);

  extern template PINOCCHIO_EXPLICIT_INSTANTIATION_DECLARATION_DLLAPI context::Matrix3x & computeStaticRegressor
  ...
  extern template PINOCCHIO_EXPLICIT_INSTANTIATION_DECLARATION_DLLAPI void bodyRegressor
  ...
  extern template PINOCCHIO_EXPLICIT_INSTANTIATION_DECLARATION_DLLAPI context::BodyRegressorType bodyRegressor
    <context::Motion, context::Motion>
    (const MotionDense<context::Motion> &, const MotionDense<context::Motion> &);

  extern template PINOCCHIO_EXPLICIT_INSTANTIATION_DECLARATION_DLLAPI context::BodyRegressorType & jointBodyRegressor
    <context::Scalar, context::Options, JointCollectionDefaultTpl>
    (const context::Model &, context::Data &, JointIndex);

  extern template PINOCCHIO_EXPLICIT_INSTANTIATION_DECLARATION_DLLAPI context::BodyRegressorType & frameBodyRegressor
    <context::Scalar, context::Options, JointCollectionDefaultTpl>
    (const context::Model &, context::Data &, FrameIndex);

  extern template PINOCCHIO_EXPLICIT_INSTANTIATION_DECLARATION_DLLAPI context::MatrixXs & computeJointTorqueRegressor
