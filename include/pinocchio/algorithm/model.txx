...
namespace pinocchio {
  ...
  extern template PINOCCHIO_EXPLICIT_INSTANTIATION_DECLARATION_DLLAPI void appendModel
  ...
  extern template PINOCCHIO_EXPLICIT_INSTANTIATION_DECLARATION_DLLAPI context::Model appendModel
    <context::Scalar, context::Options, JointCollectionDefaultTpl>
  ...
  extern template PINOCCHIO_EXPLICIT_INSTANTIATION_DECLARATION_DLLAPI context::Model buildReducedModel
    <context::Scalar, context::Options, JointCollectionDefaultTpl, context::VectorXs>
  ...
  extern template PINOCCHIO_EXPLICIT_INSTANTIATION_DECLARATION_DLLAPI JointIndex findCommonAncestor
    <context::Scalar, context::Options, JointCollectionDefaultTpl>
