...
namespace pinocchio
{
    ...
    namespace internal
    {
                            ...
                            const ReachableSetParams &params)
        {
            ...
            int ncomb = static_cast<int> (boost::math::factorial<double>(static_cast<unsigned int>(model.nv)) / boost::math::factorial<double>(static_cast<unsigned int>(params.facet_dims)) / boost::math::factorial<double>(static_cast<unsigned int>(model.nv - params.facet_dims)));
            ...
            // Rng variable
            VectorXd x_rng = VectorXd::LinSpaced(params.n_samples, 0, params.n_samples - 1) / params.n_samples;
