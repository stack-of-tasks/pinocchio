...
namespace pinocchio {
namespace impl {
  extern template PINOCCHIO_EXPLICIT_INSTANTIATION_DECLARATION_DLLAPI void computeCentroidalDynamicsDerivatives
  ...
  extern template PINOCCHIO_EXPLICIT_INSTANTIATION_DECLARATION_DLLAPI void getCentroidalDynamicsDerivatives
    <context::Scalar, context::Options, JointCollectionDefaultTpl,
