...
namespace pinocchio {
  ...
  extern template PINOCCHIO_DLLAPI context::Scalar computeTotalMass
  ...
  extern template PINOCCHIO_DLLAPI void computeSubtreeMasses
    <context::Scalar, context::Options, JointCollectionDefaultTpl>
    (const context::Model &, context::Data &);
namespace impl {
...
namespace impl {
  ...
  extern template PINOCCHIO_DLLAPI const context::Vector3 & getComFromCrba
    <context::Scalar, context::Options, JointCollectionDefaultTpl>
    (const context::Model &, context::Data &);

  extern template PINOCCHIO_DLLAPI const context::Matrix3x & getJacobianComFromCrba
    <context::Scalar, context::Options, JointCollectionDefaultTpl>
    (const context::Model &, context::Data &);
