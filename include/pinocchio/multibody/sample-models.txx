...
namespace pinocchio {
  namespace buildModels {
    extern template PINOCCHIO_EXPLICIT_INSTANTIATION_DECLARATION_DLLAPI void manipulator
      <context::Scalar, context::Options, JointCollectionDefaultTpl>
    (context::Model &);

    extern template PINOCCHIO_EXPLICIT_INSTANTIATION_DECLARATION_DLLAPI void humanoid
      <context::Scalar, context::Options, JointCollectionDefaultTpl>
    (context::Model &, bool);

    extern template PINOCCHIO_EXPLICIT_INSTANTIATION_DECLARATION_DLLAPI void humanoidRandom
      <context::Scalar, context::Options, JointCollectionDefaultTpl>
    (context::Model &, bool);
  } // namespace buildModels
} // namespace pinocchio 
