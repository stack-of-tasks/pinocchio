...
struct InstanceFilterBase
{
  ...
  ///
  /// \brief Apply the filter on the given vector of objects and returns the list of indexes of the objects matching the filter conditions.
  ///
  ...
  {
    std::vector<size_t> res; res.reserve(object_vector.size());
