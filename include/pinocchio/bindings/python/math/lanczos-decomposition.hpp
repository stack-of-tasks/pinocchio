...
//        static const Scalar dummy_precision = Eigen::NumTraits<Scalar>::dummy_precision();
        ...
        cl
          .def(bp::init<const context::MatrixXs &, const Eigen::DenseIndex>
             ((bp::arg("self"),bp::arg("mat"),bp::arg("decomposition_size")),
              "Default constructor from a given matrix and a given decomposition size."))
        
          .def("compute",&LanczosDecomposition::template compute<context::MatrixXs>,bp::args("self","mat"),
               "Computes the Lanczos decomposition for the given input matrix.")
        
          .def("Ts",(TridiagonalMatrix & (LanczosDecomposition::*)())&LanczosDecomposition::Ts,bp::arg("self"),
               "Returns the tridiagonal matrix associated with the Lanczos decomposition.",
               bp::return_internal_reference<>())
          .def("Qs",(PlainMatrix & (LanczosDecomposition::*)())&LanczosDecomposition::Qs,bp::arg("self"),
               "Returns the orthogonal basis associated with the Lanczos decomposition.",
               bp::return_internal_reference<>())
        
          .def("rank",&LanczosDecomposition::rank,bp::arg("self"),
               "Returns the rank of the decomposition.")
        
        .def("computeDecompositionResidual",&LanczosDecomposition::template computeDecompositionResidual<context::MatrixXs>,
             bp::args("self","mat"),"Computes the residual associated with the decomposition, namely, the quantity \f$ A Q_s - Q_s T_s \f$")
...
#endif
        bp::class_<LanczosDecomposition,HolderType>("LanczosDecomposition",
