...
namespace pinocchio
{
  namespace python
  {
    ...
    : public boost::python::def_visitor< CoulombFrictionConePythonVisitor<CoulombFrictionCone> >
    {
      ...
      {
        cl
        .def(bp::init<const Scalar &>(bp::args("self","mu"),"Default constructor"))
      ...
      static void expose()
      {
        bp::class_<CoulombFrictionCone>("CoulombFrictionCone",
...
//        .def(ExposeConstructorByCastVisitor<CoulombFrictionCone,::pinocchio::CoulombFrictionCone>())
    ...
    : public boost::python::def_visitor< DualCoulombFrictionConePythonVisitor<DualCoulombFrictionCone> >
    {
      ...
      static void expose()
      {
        bp::class_<DualCoulombFrictionCone>("DualCoulombFrictionCone",
