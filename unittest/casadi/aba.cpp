...
BOOST_AUTO_TEST_CASE(test_aba_casadi_algo)
{
  ...
  ad_casadi.initLib();
  std::cout << "Number of operations in the ABA function = " << ad_casadi.ad_fun_num_operations << "\n";
  std::cout << "Number of operations in the ABA derivs function = " << ad_casadi.ad_fun_derivs_num_operations << "\n";
  ad_casadi.loadLib();
