...
BOOST_AUTO_TEST_CASE(test_linear_robot)
{
  ...
  g.addBody("body2", pinocchio::Inertia(0., Vector3(0., 2., 0.), Symmetric3::Zero()));
  g.addBody("body3", pinocchio::Inertia(0., Vector3(0., -3, -2.), Symmetric3::Zero()));
  g.addJoint(
    "body1_to_body2", JointModel(pinocchio::JointModelRZ()), "body1",
    SE3(Eigen::Matrix3d::Identity(), Eigen::Vector3d(2., 0., 0.)), "body2",
    SE3(Eigen::Matrix3d::Identity(), Eigen::Vector3d(2., 2., 0.)));
  g.addJoint(
    "body2_to_body3", JointModel(pinocchio::JointModelRZ()), "body2",
    SE3(Eigen::Matrix3d::Identity(), Eigen::Vector3d(2., -2., 0.)), "body3",
    SE3(Eigen::Matrix3d::Identity(), Eigen::Vector3d(4., -3., 0.)));
