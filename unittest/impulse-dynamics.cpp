...
//  const Model::JointIndex LF_id = model.getJointId(LF);
  ...
  for(size_t k = 0; k < contact_models.size(); ++k)
  {
    ...
    switch(cmodel.type)
    {
      ...
      {
        ForceRef<Data::VectorXs::FixedSegmentReturnType<6>::Type> f_ref(data_ref.impulse_c.segment<6>(constraint_id));
...
//  const Model::JointIndex LF_id = model.getJointId(LF);
  ...
  updateFramePlacements(model,data_ref);
  getFrameJacobian(model,data_ref,model.getFrameId(RF),LOCAL,J_ref.middleRows<6>(0));
  getFrameJacobian(model,data_ref,model.getFrameId(LF),LOCAL,J_ref.middleRows<6>(6));
...
//  const Model::JointIndex LF_id = model.getJointId(LF);
  ...
  updateFramePlacements(model,data_ref);
  getFrameJacobian(model,data_ref,model.getFrameId(RF),LOCAL_WORLD_ALIGNED,J_ref.middleRows<6>(0));
  getFrameJacobian(model,data_ref,model.getFrameId(LF),LOCAL_WORLD_ALIGNED,J_ref.middleRows<6>(6));
...
//  const Model::JointIndex LF_id = model.getJointId(LF);
  ...
  updateFramePlacements(model,data_ref);
  getFrameJacobian(model,data_ref,model.getFrameId(RF),WORLD,J_ref.middleRows<6>(0));
  getFrameJacobian(model,data_ref,model.getFrameId(LF),WORLD,Jtmp);
