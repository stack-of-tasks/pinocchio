...
if(GMP_INCLUDE_DIR AND NOT TARGET GMP::GMP)
    ...
    string(REGEX MATCH "#define[ \t]__GNU_MP_VERSION[ \t]+([0-9]+)" _match_major ${gmp_h})
    set(GMP_VERSION_MAJOR ${CMAKE_MATCH_1})
    string(REGEX MATCH "#define[ \t]__GNU_MP_VERSION_MINOR[ \t]+([0-9]+)" _match_major ${gmp_h})
    set(GMP_VERSION_MINOR ${CMAKE_MATCH_1})
    string(REGEX MATCH "#define[ \t]__GNU_MP_VERSION_PATCHLEVEL[ \t]+([0-9]+)" _match_major ${gmp_h})
    set(GMP_VERSION_MICRO ${CMAKE_MATCH_1})
    set(GMP_VERSION ${GMP_VERSION_MAJOR}.${GMP_VERSION_MINOR}.${GMP_VERSION_MICRO})
endif()
